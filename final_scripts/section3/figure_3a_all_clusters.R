...
png(paste0(plotDirectory, "figures/supercluster_identification_all_clusters.png"),
    width = 20,height=20, units = 'in',res = 300)

draw(ht, column_title="Correlations of Clusters Differential Mean Expression of Most Variable Genes",
