...
for(curr_cell_line in cell_lines){
  ...
  curr_clusters <- 1:length(all_ranks[[curr_cell_line]])
...
saveRDS(hallmark_results, paste0(dataDirectory, "enrichment_results/all_cluster_hallmark_results.rds"))
saveRDS(mp_results, paste0(dataDirectory, "enrichment_results/all_cluster_mp_results.rds"))
saveRDS(go_results, paste0(dataDirectory, "enrichment_results/all_cluster_go_results.rds"))
