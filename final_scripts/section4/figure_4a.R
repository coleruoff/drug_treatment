...
curr_cell_line <- "A549"
for(curr_cell_line in cell_lines[1:3]){
  cat(curr_cell_line, "\n")
  ...
  # if(tcga_project == "TCGA-BRCA"){
  # 
  # 
  #   lumA_sample_names <- PanCancerAtlas_subtypes() %>%
  #     filter(cancer.type == "BRCA" & Subtype_Selected == "BRCA.LumA") %>%
  #     pull(pan.samplesID)
  # 
  # 
  # 
  #   tcga_matrix_vst <- tcga_matrix_vst[,colnames(tcga_matrix_vst) %in% lumA_sample_names]
  # }
