...
AMR_de <- read_xlsx(paste0(dataDirectory, "ecoli_data/AMR_de_genes.xlsx"))
...
saveRDS(ecoli_AMR_genesets_up, paste0(dataDirectory, "ecoli_data/ecoli_AMR_genesets_up.rds"))
saveRDS(ecoli_AMR_genesets_down, paste0(dataDirectory, "ecoli_data/ecoli_AMR_genesets_down.rds"))

ecoli_AMR_genesets_up <- readRDS(paste0(dataDirectory, "ecoli_data/ecoli_AMR_genesets_up.rds"))
ecoli_AMR_genesets_down <- readRDS(paste0(dataDirectory, "ecoli_data/ecoli_AMR_genesets_down.rds"))
...
human_ecoli_conversion <- read.table(paste0(dataDirectory, "ortholog_mapping/human_ecoli_source_id.txt"), fill = T, sep='\t')[,1:3]
...
ecoli_genename_geneid_conversion_table <- read.table(paste0(dataDirectory, "ecoli_data/ecoli_genename_geneid_conversion_table.txt"), fill = T)
...
saveRDS(upregulated_ecoli_human_orthologs_table, paste0(dataDirectory, "genesets/orthologs/upregulated_ecoli_human_orthologs_table.rds"))
saveRDS(downregulated_ecoli_human_orthologs_table, paste0(dataDirectory, "genesets/orthologs/downregulated_ecoli_human_orthologs_table.rds"))
