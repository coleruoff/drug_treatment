...
raj_resistant_2 <- readRDS(paste0("/data/CDSL_hannenhalli/Cole/projects/drug_treatment/final_data/processed_data/diverse_clonal_fates_data/raj_resistant_", raj_resistant_cancer_type, "_processed.rds"))
