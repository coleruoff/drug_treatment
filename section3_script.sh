...
Rscript --vanilla ${source_directory}create_all_clsuter_tf_lists.R $working_directory
...
Rscript --vanilla ${source_directory}supplementary_table3.R $working_directory
