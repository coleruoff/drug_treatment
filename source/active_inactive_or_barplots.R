...
jpeg(paste0("/data/CDSL_hannenhalli/Cole/projects/drug_treatment/final_figures/active_inactive_or_figures/figure_1c.jpeg"),
     width=1500, height=1500)

figure <- ggarrange(plotlist = plots, nrow=3, common.legend = T,legend=c("right"))

annotate_figure(figure, left = text_grob("Odds Ratio", rot = 90, vjust = 1, size=35, face="bold"),
