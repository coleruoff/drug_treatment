...
Idents(A549.data) <- A549.data$cell_cluster_group
...
Idents(K562.data) <- K562.data$cell_cluster_group
...
Idents(MCF7.data) <- MCF7.data$cell_cluster_group
