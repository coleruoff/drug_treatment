...
human_yeast_conversion <- read.table("/data/CDSL_hannenhalli/Cole/projects/drug_treatment/data/ortholog_mapping/human_candida_auris_source_id.txt", fill = T, sep='\t')[,1:3]
...
saveRDS(upregulated_yeast_human_orthologs_table, "/data/CDSL_hannenhalli/Cole/projects/drug_treatment/data/genesets/orthologs/upregulated_yeast_human_orthologs_table.rds")
saveRDS(downregulated_yeast_human_orthologs_table, "/data/CDSL_hannenhalli/Cole/projects/drug_treatment/data/genesets/orthologs/downregulated_yeast_human_orthologs_table.rds")
