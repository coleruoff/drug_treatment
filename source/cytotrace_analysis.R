...
cat("TEST2")
# Sys.setenv(RETICULATE_PYTHON="C:/Users/ruoffcj/AppData/Local/Programs/Python/Python310/bin")
...
# 
# expr_matrix <- expr_matrix[which(rownames(expr_matrix) %in% variable_genes),]
# 
# dim(expr_matrix)
# 
# results <- CytoTRACE(as.matrix(expr_matrix), ncores = 48, subsamplesize = 3000)
# 
# 
# saveRDS(results, paste0("/data/CDSL_hannenhalli/Cole/", curr_cell_line, "_cytoTRACE_results.rds"))

#####################################################################################
## Running with gene-filtered matrix
...
# 
# 
# expr_matrix <- all_data@assays$originalexp@data
# 
# 
# dim(expr_matrix)
# results <- CytoTRACE(expr_matrix, ncores = 16, subsamplesize = 1000)
# 
# 
# saveRDS(results, paste0("/data/CDSL_hannenhalli/Cole/", curr_cell_line, "_cytoTRACE_results_gene_filtered.rds"))
# 
# 
# 
# 
