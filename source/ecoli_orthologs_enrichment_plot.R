...
ecoli_human_orthologs_up <- readRDS("/data/CDSL_hannenhalli/Cole/projects/drug_treatment/data/genesets/ecoli_human_orthologs_up.rds")

names(ecoli_human_orthologs_up) <- NULL

all_dotplots <- genesets_characterization(ecoli_human_orthologs_up)
...
png(paste0("/data/ruoffcj/projects/drug_treatment/figures/ecoli_orthologs_enrichment_plots.png"),
    width=30, height=14, units= "in", res = 300)
...
p <- annotate_figure(figure, left = text_grob("", rot = 90, vjust = 1, size=35, face="bold"),
                     ...
                     top=text_grob("Enrichment of E. coli Antimicrobial Resistance Orthologs\n", size=35, face="bold"))
