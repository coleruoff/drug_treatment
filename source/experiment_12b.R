...
# RACs <- list(c(9,12,13,14,16,18),c(4,5,9,11),c(5,8,13,17))
...
table(all_data[[1]]$Phase[all_data[[1]]$emergent_rac == "emergent_rac"])
table(all_data[[1]]$Phase[all_data[[1]]$emergent_rac == "non_emergent_rac"])
table(all_data[[1]]$Phase[all_data[[1]]$emergent_rac == "non_emergent_rac"])


all_data[[1]]@meta.data %>% 
  count(emergent_rac, Phase)


3969/(3969+631+470)

5882/(5882+16494+6024)

44537/(44537+27336+34315)
