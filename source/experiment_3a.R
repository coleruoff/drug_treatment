...
saveRDS(hazard_ratio_df, "/data/CDSL_hannenhalli/Cole/projects/drug_treatment/data/experiment_data/experiment_3_hazard_ratio_df.rds")
...
png("/data/ruoffcj/projects/drug_treatment/figures/experiment3_km_plot.png",
    width=30, height=70, units= "in", res=300)
