...
geneset_to_use <- c(rac_type_signatures[1],supercluster_signature)
...
facet_names <- c("A549 RAC Signature","RAC Supercluster Signature")
...
plots <- list(pre_plot,post_plot)



figure <- ggarrange(plotlist = plots, nrow=2, common.legend = T,legend=c("right"))
