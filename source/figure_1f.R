...
geneset_to_use <- "ITH_meta_programs"
...
for(curr_cell_line in cell_lines){
  ...
  trapnell_subset_names <- sample(rownames(trapnell_scores), (.6*nrow(trapnell_scores)))
...
png(paste0(dataDirectory, "final_figures/figure_1f.png"),
