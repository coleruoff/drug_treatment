...
if(clean_geneset_name == "ITH Meta-Programs"){
  jpeg(paste0("/data/CDSL_hannenhalli/Cole/projects/drug_treatment/final_figures/distances_to_raj_boxplots/figure_1g.jpeg"),
       width=2000, height=1000,, res = 300)
} else {
  jpeg(paste0("/data/CDSL_hannenhalli/Cole/projects/drug_treatment/final_figures/distances_to_raj_boxplots/figure_1f.jpeg"),
       width=2000, height=1000, res = 300)
}
...
p <- annotate_figure(figure, left = text_grob("Score", rot = 90, vjust = 1, size=35, face="bold"),
                ...
                top=text_grob(paste0("Cluster Distances to Resistant Clusters in ", clean_geneset_name, " Expression Space"), size=40, face="bold"))
