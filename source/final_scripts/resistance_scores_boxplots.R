...
jpeg(paste0("/data/CDSL_hannenhalli/Cole/projects/drug_treatment/final_figures/resistance_score_boxplots/figure_1b.jpeg"),
    width=1500, height=1500)

figure <- ggarrange(plotlist = plots, nrow=3, common.legend = T,legend=c("right"))

annotate_figure(figure, left = textGrob("Score", rot = 90, vjust = 1, gp = gpar(fontsize=35, fontface="bold")),
