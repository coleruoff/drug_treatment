...
if(metric_to_use == "OS"){
  ...
  saveRDS(plot_data, "/data/CDSL_hannenhalli/Cole/projects/drug_treatment/data/figure_data/pan_cancer_OS_plot_data.rds")
  plot_data <- readRDS("/data/CDSL_hannenhalli/Cole/projects/drug_treatment/data/figure_data/pan_cancer_OS_plot_data.rds")
} else {
  saveRDS(hazard_ratio_df, "/data/CDSL_hannenhalli/Cole/projects/drug_treatment/data/survival_analysis_hazard_ratios/pan_cancer_hazard_ratios_PFS.rds")
  saveRDS(plot_data, "/data/CDSL_hannenhalli/Cole/projects/drug_treatment/data/figure_data/pan_cancer_PFS_plot_data.rds")
  plot_data <- readRDS("/data/CDSL_hannenhalli/Cole/projects/drug_treatment/data/figure_data/pan_cancer_PFS_plot_data.rds")
}
...
tcga_projects <- unique(hazard_ratio_df$project)
...
if(metric_to_use == "OS"){
  ...
  png(paste0("/data/ruoffcj/projects/drug_treatment/figures/pan_cancer_OS.png"),
      width=35, height=60, units= "in", res=300)
  
} else {
  final_title <- "RAC Type 1 Supercluster Signatures - Progression Free Survival\n"
  png(paste0("/data/ruoffcj/projects/drug_treatment/figures/pan_cancer_PFS.png"),
      width=35, height=60, units= "in", res=300)
}
