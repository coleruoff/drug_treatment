...
jpeg(paste0("/data/CDSL_hannenhalli/Cole/projects/drug_treatment/final_figures/resistance_score_boxplots/figure_1e.jpeg"),
     width=2000, height=1000)

figure <- ggarrange(plotlist = plots, ncol=3, common.legend = T, legend=c("right"))

annotate_figure(figure, left = text_grob("Score", rot = 90, vjust = 1, size=35, face="bold"),
