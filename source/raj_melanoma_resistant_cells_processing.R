...
sample11umPlx.data <- Read10X(data.dir = "/data/CDSL_hannenhalli/Cole/projects/drug_treatment/data/raw_data/yogesh_et_al/10X_cellRangerOuts/FM01/1_1uMPLX/filtered_feature_bc_matrix/")
sample21umPlx.data <- Read10X(data.dir = "/data/CDSL_hannenhalli/Cole/projects/drug_treatment/data/raw_data/yogesh_et_al/10X_cellRangerOuts/FM01/2_1uMPLX/filtered_feature_bc_matrix/")
...
saveRDS(s1s2_scTransform, "/data/CDSL_hannenhalli/Cole/projects/drug_treatment/data/processed_data/diverse_clonal_fates_data/raj_resistant_melanoma_processed.rds")
